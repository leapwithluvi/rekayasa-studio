...
export default function WhyMe() {
  return (
    <section className="py-24 md:py-32 px-6 bg-off-white overflow-hidden">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 md:gap-20 items-center border-t border-charcoal/5 pt-24 md:pt-32">
        <div>
        ...
        <div className="space-y-4 md:space-y-6">
          {advantages.map((adv, i) => (
            <motion.div 
              ...
              className="group p-6 md:p-10 bg-white border border-charcoal/5 rounded-sm hover:shadow-2xl hover:shadow-charcoal/5 transition-all duration-500"
            >
